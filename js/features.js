...
const Feat = (() => {
  ...
  // ================= 下載資源 =================
  // 依類別整理的通用旅遊打包清單（不含個人化細節；使用者自行增減）
  const packingTemplate = [
    { cat: '🛂 重要證件', items: ['護照（出國）', '身分證／健保卡', '駕照', '機票／車票', '簽證（如需要）', '旅遊保險證明', '訂房與票券憑證'] },
    { cat: '💳 錢包', items: ['信用卡', '現金與零錢', '交通卡'] },
    { cat: '🔌 3C 電子', items: ['手機', '充電線與充電器', '行動電源', '萬用轉接插頭', '延長線', '相機／記憶卡', '耳機'] },
    { cat: '📱 手機 App', items: ['地圖／導航', '訂房 App', '叫車 App', '大眾運輸／票務 App', '翻譯 App'] },
    { cat: '👕 衣物', items: ['上衣', '褲子／裙子', '外套', '保暖衣物', '睡衣', '帽子'] },
    { cat: '🩲 貼身衣物', items: ['內衣褲', '襪子', '泳衣'] },
    { cat: '🧴 盥洗保養', items: ['牙刷牙膏', '洗面乳', '洗髮／潤髮', '沐浴乳', '身體乳液', '卸妝用品', '毛巾', '梳子'] },
    { cat: '💄 化妝／防曬', items: ['防曬乳', '底妝／隔離', '護唇膏', '面膜', '個人彩妝'] },
    { cat: '💊 藥品', items: ['個人常用藥', '感冒藥', '止痛藥', '暈車藥', '腸胃藥', 'OK 繃', '防蚊液'] },
    { cat: '🧻 衛生用品', items: ['生理用品', '面紙／濕紙巾', '口罩', '牙線', '乾洗手'] },
    { cat: '🧳 生活用品', items: ['洗衣袋／洗衣片', '摺疊購物袋', '密封夾鏈袋', '雨傘／雨衣', '水壺', '小型行李秤'] },
    { cat: '✈️ 機上用品', items: ['頸枕', '眼罩', '耳塞', '拖鞋', '薄外套'] },
    { cat: '👶 親子／長輩（視需要）', items: ['奶粉／副食品', '尿布', '兒童藥品', '推車／揹巾', '長輩慢性病藥'] }
  ];
